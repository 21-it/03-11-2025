...
* Input: Berat (kg), jarak (km), panjang, lebar, tinggi (cm)
  
* Proses:

Hitung volume = p × l × t

Jika jarak ≤ 10 → biaya/kg = 4250, jika > 10 → 6000

Jika volume > 100 → tambah Rp 50.000

Total = (biaya/kg × berat) + biaya tambahan
...
* Proses: Cek sisa bagi 2 (n % 2)
* Output: Teks “genap” atau “ganjil”
...
* Proses: Gunakan rumus V = π × r × r × t.
...
* Input: Jumlah siswa dan nilai-nilai mereka.
* Proses: Jumlahkan semua nilai, lalu bagi dengan jumlah siswa.
...
* Input: Ukuran matriks (baris, kolom) dan elemen-elemen matriks A dan B.
* Proses: Setiap elemen dijumlahkan: C[i][j] = A[i][j] + B[i][j].
* Output: Matriks hasil penjumlahan.
